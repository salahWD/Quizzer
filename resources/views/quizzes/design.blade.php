    ...
    <div class="container quiz-content pb-5">
      ...
      <div class="d-flex flex-column justify-content-start py-4 px-5 m-auto" style="height: fit-content">
        ...
        <div class="answers my-4" id="answersContainerPreview">
          ...
          <div class="answer hover" style="color:{{ $quiz->answer_text_color }};{{ $quiz->answer_bg_color != null ? "background-color: $quiz->answer_bg_color" : "" }}">
            <div class="highlight" style="{{ $quiz->highlight_color != null ? "background-color: $quiz->highlight_color" : "" }}"></div>
            <div class="answer-letter" style="border-color: {{ $quiz->border_color }}">A</div>
        ...
        <div class="answers img-answers mb-4" id="answersContainerPreview">
          ...
          <div class="answer img-answer hover card border-0" style="min-width: 200px;color:{{ $quiz->answer_text_color }};{{ $quiz->answer_bg_color != null ? "background-color: $quiz->answer_bg_color" : "" }}">
            <div class="highlight" style="{{ $quiz->highlight_color != null ? "background-color: $quiz->highlight_color" : "" }}"></div>
            <img class="img card-img-top" src="http://placehold.it/300" width="200" height="200">
            <p class="text m-0" id="Answer-3-preview">asd</p>
          </div>
...
@section('options')
  ...
  <div class="sidebar">
    ...
    <div class="quiz-options bg-white">
      <form action="{{ route("select_theme_quiz", compact("quiz")) }}" id="theme_form" method="POST">
        @csrf
        <div class="content">
          <div class="row">
      ...
      <form action="{{ route("update_design_quiz", compact("quiz")) }}" id="design_form" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="content">
